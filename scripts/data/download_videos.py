...
사용법:
  ...
  python scripts/data/download_videos.py --cookies path/to/cookies.txt
"""
import argparse
import json
import os
...
def main():
    ...
    payload = {
        "schema_version": 1,
        "description": "video_ids of YouCook2 videos that failed to download via scripts/data/download_videos.py. Used by downstream preprocessing scripts to exclude these videos from the available annotation set.",
        "count": len(failed),
